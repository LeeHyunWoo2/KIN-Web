...
const technologies = {
  ...
  frontend_etc: [
    {name: "frontend_etc_sample 1", description: "sample 1"},
    {name: "frontend_etc_sample 2", description: "sample 2"},
    {name: "frontend_etc_sample 3", description: "sample 3"},
    {name: "frontend_etc_sample 4", description: "sample 4"},
  ],
  backend: [
    ...
    { name: "Redis", description: "메모리 기반 데이터베이스", icon: "redis" },
  ...
  backend_etc: [
    {name: "backend_etc_sample 1", description: "sample 1"},
    {name: "backend_etc_sample 2", description: "sample 2"},
    {name: "backend_etc_sample 3", description: "sample 3"},
    {name: "backend_etc_sample 4", description: "sample 4"},
  ],
  deployment: [
    ...
    { name: "Cloudflare", description: "DNS 레코드 설정, SSL 인증 및 네트워크 보안.", icon: "cloudflare"},
  ]
};
