...
const technologies = {
  frontend: [
    { name: "React", description: "컴포넌트 기반 UI", icon: "react", url: "https://react.dev"},
    { name: "Next.js", description: "React 기반 웹 개발 프레임워크", icon: "next", url: "https://nextjs.org/"},
    ...
    { name: "Jotai", description: "전역 상태 관리", icon: "jotai" , url: "https://jotai.org/"},
  ],
  frontend_etc: [
  ...
  backend: [
    ...
    { name: "Passport.js", description: "OAuth 기반 소셜 인증", icon: "passport" , url: "https://www.passportjs.org/"},
  ...
  backend_etc: [
    ...
    { name: "OAuth2.0", description: "소셜 로그인 인증 및 권한 부여", url: "https://oauth.net/2/" },
    { name: "Morgan", description: "HTTP 요청 로깅 미들웨어", url: "https://github.com/expressjs/morgan" },
    { name: "Express Rate Limit", description: "API 요청 속도 제한", url: "https://github.com/express-rate-limit/express-rate-limit" },
    { name: "Dotenv", description: "환경 변수 관리", url: "https://github.com/motdotla/dotenv" },
  ],
  deployment: [
